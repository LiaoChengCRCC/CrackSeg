...
## Datasets
To evaluate the proposed method, experiments were conducted on the public CrackSeg9k dataset and a newly constructed Fine-Crack dataset targeting fine-scale crack segmentation.
